...
import com.hotcaffeine.dashboard.service.LineChartService;
import com.hotcaffeine.dashboard.view.PageView;
import com.hotcaffeine.dashboard.view.SearchHeader;
import com.hotcaffeine.dashboard.view.SearchHeader.SearchField;
import com.hotcaffeine.dashboard.view.SearchHeader.SearchFieldType;
import com.hotcaffeine.dashboard.view.SearchHeader.SelectSearchField;
import com.hotcaffeine.dashboard.view.SearchHeader.SelectSearchField.KV;
    ...
    public static class HighChartLine {
        ...
        public HighChartLine(LineChart lineChart) {
            ...
            for (YAxisGroup yAxisGroup : lineChart.getyAxisGroupList()) {
                ...
                if (yAxisGroup.getFormatSuffix() != null) {
                    yAxisMap.put("formatSuffix", yAxisGroup.getFormatSuffix());
                }
                yAxis.add(yAxisMap);
            }
